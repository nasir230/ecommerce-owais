...
<div class="container-fluid">
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="card">
          <div class="header">
            <h2><strong>Create</strong> Testimonials</h2>
          ...
          <div class="body">
            @if ($errors->any())
                    ...
                    @endforeach
            @endif
            <form method="post" enctype="multipart/form-data" action="{{route('admin.testimonals.store')}}" id="form_sample_1" class="form-horizontal">
                @csrf
                    <div class="form-body">
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <input required type="text" name="name" class="form-control input-height" /> 
                            </div>
                            <div class="col-md-12">
