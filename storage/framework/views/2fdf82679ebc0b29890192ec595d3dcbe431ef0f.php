    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="row align-items-center">
                ...
                <img class="img-fluid rounded" src="<?php echo e(asset('front/assets/images/product1.png')); ?>" alt="">
                </div>
                <div class="col-lg-8 col-12 mt-5 mt-lg-0">
                <div class="product-details">
                <h3 class="mb-0"><?php echo e($product->title); ?></h3>
...
</div><?php /**PATH C:\xampp\htdocs\zmark\resources\views/components/productView.blade.php ENDPATH**/ ?>